...
function [state,component] = off_turb(state,component,M9,A45_9,componentR)
...
Po19_P19 = pi_r*pi_d(2)*pi_f*pi_n;
Pr19 = Pro19 / Po19_P19;
state(15,2) = {Pr19};
state(15,3) = {[]};
state(15,8) = {[]};
...
Po9_P9 = pi_r*pi_d(2)*pi_cL*pi_cH*pi_b*pi_tH*pi_tL*pi_n;
Pr9 = Pro9 / Po9_P9;
state(18,2) = {Pr9};
state{18,3} = [];
state{18,8} = [];
...
%F = mdot9*(v9-v0) + mdot19*(v19-v0);

F = mdot19*v19 +mdot9*v9 - mdot0*v0;

S = mdotf / F;

%S = f/((1+alpha)*(F/(mdot9+mdot19)))
