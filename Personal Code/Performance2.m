...
max_takeoff_speed = 100;
mdot_low = 0;
mdot_high = A0*max_takeoff_speed*1.225; %kg/s
error = 1;
...
S_scaled = SFC_takeoff/S(1,1).*S;
F_scaled = T_takeoff/F(1,1).*F;

%% DGEN DATA
dgen390.M(:,1) = linspace(0,.45,19);
dgen390.F(:,1) = [739.74;712.95;687.25;662.58;638.87;616.06;594.09;572.88;552.39;532.56;513.31;494.59;476.35;458.52;441.05;423.89;406.97;390.25;373.67];
dgen390.F(:,2) = [532.77;513.41;495.01;477.50;460.82;444.91;429.71;415.16;401.20;387.78;374.83;362.30;350.13;338.27;326.67;315.26;303.99;292.77;279.78];
dgen390.F(:,3) = [358.46;345.16;332.69;320.99;309.99;299.64;289.89;280.27;271.07;262.25;253.76;245.55;237.56;229.74;222.03;214.39;206.75;199.08;191.30];

dgen390.S(:,1) = [.46;.48;.50;.51;.53;.55;.57;.59;.61;.63;.66;.68;.7;.73;.75;.78;.81;.84;.87];
dgen390.S(:,2) = [.45;.47;.49;.51;.52;.54;.56;.58;.60;.62;.64;.66;.68;.70;.73;.75;.77;.8;.83];
dgen390.S(:,3) = [.45;.47;.49;.50;.52;.54;.55;.57;.59;.61;.62;.64;.66;.68;.7;.72;.74;.76;.78];
...
%% Plots to Output to GUI

for plots = 1
h11 = figure(11);
h11.WindowStyle = 'docked'; 
for i = 1:length(alt)
plot(M0,F_scaled(i,:),'linewidth',1.5)
hold on
title('Thrust vs. Mach Number')
xlabel('Mach Number')
ylabel('Thrust (kN)')
...
h12 = figure(12);
h12.WindowStyle = 'docked';
for i = 1:length(alt)
plot(M0,S_scaled(i,:),'linewidth',1.5)
title('SFC vs. Mach Number')
hold on
xlabel('Mach Number')
ylabel('SFC')
