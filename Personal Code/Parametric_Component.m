...
% Fill out overall pressure and enthalpy ratios
% no pi_b or pi_AB
% Tt/T values are off, need to find out why

% CREATED 'INPUTS' CELL 
% TO DO
%   Implement INPUTS cell into combined functions
%       -> currently only implemented into seperate functions
...
function [state,design] = derived_parameters(state,inputs,eta_b,design)
%% Derived Parameters
