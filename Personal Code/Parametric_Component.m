...
%% Analysis
[state_s,component_s,performance_s] = component_seperate(state,component,alt,M0,mdotep1,Po9_P9,design);
...
function [state,component,performance] = component_seperate(state,component,alt,M0,mdotep1,Po9_P9,design)
    ...
    [state,component] = LPturb(state,component,design,mdotep1);
...
function [error] = sensitivity(S,F_mdot,state_i,component_i,alt_i,M0_i,mdotep1_i,Po9_P9_i,design_i,delta_val);
[~,~,performance_i] = component_seperate(state_i,component_i,alt_i,M0_i,mdotep1_i,Po9_P9_i,design_i);
