function [state,component,design, inputs, performance] = on_design(alt,M0,pi_f,pi_cL,pi_cH,alpha,beta,PtoH,PtoL,A0,year,To_burner)
%% Read Me
...
% Assumptions used by both the book analysis and our analysis

% FLOW IS STEADY ON AVERAGE

% FLOW IS 1D THROUGH EACH COMPONENT

% FLOW BEHAVES LIKE PERFECT GAS
...
% ANALYSIS IS FOR A SEPERATE EXHAUST TURBOFAN
    % BYPASS NOZZLE ASSUMES A PRESSURE RATIO AND BEHAVIOR OF THE CORE NOZZLE
    % NOZZLES ARE PERFECTLY EXPANDED P0=P9=P19

% PRESSURE RATIOS, POLYTROPIC EFFICIENCIES, AND MAX BURNER TEMP DEFINED BY
% LEVEL OF TECH

% INSTALLATION EFFECTS AND SELF DRAG NEGLECTED
...
% Find and store burner enthalpy ratios
taub = ho4/ho31;
component{7,4} = taub;
[state,design] = mdot(state,design);
tau_lambda = ho4/h0;
