...
% component(2:16,2) = {3.4211; .9354; 3.9000; 3.9000; 5.1282; []; [];    .4231; []; [];    .5023; []; .9735; []; pi_n};
% component(2:16,4) = {1.4211; [];    1.5479; 1.5479; 1.6803; []; .9673; .8381; []; .9731; .8667; []; .8268; []; []};
% 
...
% alpha/(1+state{18,4}) * state{13,2}/state{5,2} * sqrt(state{5,3}/state{13,3})
% 
% ans =
% 
%    12.2424
