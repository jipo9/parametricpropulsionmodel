...
M0 = 1.6;
T0 = 394.1 * .555556; %deg Kelvin (from Rankine)
...
% F_over_mdot = T / mdottotal;
    F_over_mdot =12572*(4.448/.454); %N/(kg/s) from lbf/(lbm/s)
S = 1.1386*(.454/4.448); %kg/N-hr (from lbm/lbf-hr)
% pitotal = ;
    Pt9oP9 = 12.745;
    Pt0oP0 = Po0 / P0;
    P0oP9 = 1;
    pitotal = Pt9oP9 / P0oP9 / Pt0oP0; 
br = 1/.4; %bypass ratio
...
% mdotf = S*T;
    mdotfomdot = S*F_over_mdot/3600; %unitless
% mdotbypass = mdottotal/(2*br); %after bypass leaves
% mdotburner = mdotbypass*(1-betta - ep1 -ep2); %after bleed and coolant leaves
% f = mdotf / mdotburner;
    percentm_bypass = 1/(2*br); %after bypass leaves
    percentm_burner = percentm_bypass*(1-betta - ep1 -ep2); %after bleed and coolant leaves
    f = mdotfomdot / percentm_burner;
...
[Po13,To13,rhoo13,mdot13] = fan(Po2,To2,R,gamma,mdottotal,br,ef,pif);
Pr = Po13 / 51850
%good
...
[Po3,To3,rhoo3,mdot31] = HPcomp(Po25,To25,R,gamma,mdot13,betta,ep1,ep2,pich,ech);
Pr = Po3 / 51850
%good
%% Burner

[Po4,To4] = burner(Po3,To3,mdot31,f,gamma,R,hPR,etab);
Pr = Po4 / 51850
